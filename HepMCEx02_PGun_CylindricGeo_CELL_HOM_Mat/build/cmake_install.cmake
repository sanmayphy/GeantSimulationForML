...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/Users/antonc/Documents/GitHub/Master/InOne/HepMCEx02_PGun_CylindricGeo_CELL_HOM_Mat/build/HepMCEx02")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/HepMCEx02" AND
    ...
    execute_process(COMMAND /usr/bin/install_name_tool
      ...
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/HepMCEx02")
    execute_process(COMMAND /usr/bin/install_name_tool
      -delete_rpath "/Users/antonc/Documents/GitHub/Master/InOne/HepMCEx02_PGun_CylindricGeo_CELL_HOM_Mat/build"
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/HepMCEx02")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" -u -r "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/HepMCEx02")
    endif()
  endif()
endif()
...
file(WRITE "/Users/antonc/Documents/GitHub/Master/InOne/HepMCEx02_PGun_CylindricGeo_CELL_HOM_Mat/build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
