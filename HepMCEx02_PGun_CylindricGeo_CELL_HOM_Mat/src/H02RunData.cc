...
void H02RunData::FillPerEvent()
{
  ...
  //  runAction->Total_Esc_Energy = fTotal_Esc_Energy;
  //  runAction->Total_Enotrc_Energy = fTotal_Enotrc_Energy;
  //  runAction->Total_Had_Ch_Energy = fTotal_Had_Ch_Energy;
  //  runAction->Total_Had_Nu_Energy = fTotal_Had_Nu_Energy;
   runAction->Total_EM_Energy = fTotal_EM_Energy;
  //  runAction->Kin_Ch_Energy = fKin_Ch_Energy;
  //  runAction->Kin_Nu_Energy = fKin_Nu_Energy;
  //  runAction->True_Ch_Energy = fTrue_Ch_Energy;
  //  runAction->True_Nu_Energy = fTrue_Nu_Energy;
   runAction->nbRadLen = fnbRadLen;//Geantino
   runAction->ro0  = 0;
   runAction->ro0 = fVariable;
   for(G4int iLayer = 0; iLayer < kLayer; iLayer++)
   {
    for(G4int iEtacell = 0; iEtacell < K_NETA; iEtacell++)
    {
...
//        runAction->PArray        [iLayer][iEtacell][iPhicell] = fPArray        [iLayer][iEtacell][iPhicell];
        // runAction->HadCh_Cell_Energy[iLayer][iEtacell][iPhicell] = fHadCh_Cell_Energy[iLayer][iEtacell][iPhicell] ;
        // runAction->HadNu_Cell_Energy[iLayer][iEtacell][iPhicell] = fHadNu_Cell_Energy[iLayer][iEtacell][iPhicell] ;
        // runAction->EM_Cell_Energy[iLayer][iEtacell][iPhicell] = fEM_Cell_Energy[iLayer][iEtacell][iPhicell] ;
      }
    }
  }
...
{ 
  ...
  for(G4int iLayer = 0; iLayer < kLayer; iLayer++)
  {
    for(G4int iEtacell = 0; iEtacell < K_NETA; iEtacell++)
    {
      for(G4int iPhicell = 0; iPhicell < K_NPHI; iPhicell++)
      {
        ...
        fCh_Cell_Energy[iLayer][iEtacell][iPhicell] = 0. ;
        fNu_Cell_Energy[iLayer][iEtacell][iPhicell] = 0. ;
        fPArray        [iLayer][iEtacell][iPhicell].chEnergy = 0;
        fPArray        [iLayer][iEtacell][iPhicell].nuEnergy = 0;
        fPArray        [iLayer][iEtacell][iPhicell].prtcl.clear();
        fKin_Ch_Energy = 0. ;
        fKin_Nu_Energy = 0.;
      }
    }
  ...
  fTotal_Nu_Energy = 0;
  fTotal_Esc_Energy = 0;
  fTotal_Enotrc_Energy = 0;
  fTotal_Had_Ch_Energy = 0;
  fTotal_Had_Nu_Energy = 0;
  fTotal_EM_Energy = 0;
  fVariable = 0;
