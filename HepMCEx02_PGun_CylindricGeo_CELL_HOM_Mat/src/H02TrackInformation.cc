...
// ********************************************************************
//
/// \file runAndEvent/H02/src/H02TrackInformation.cc
/// \brief Implementation of the H02TrackInformation class
//
//
//
...
G4ThreadLocal G4Allocator<H02TrackInformation> *
                                   aTrackInformationAllocator = 0;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
H02TrackInformation::H02TrackInformation()
  : G4VUserTrackInformation()
{
    ...
    fOriginalParentID = -1;
    fProcessID = -1; 
    fOriginalParticleName = "NOPARTICLE";
    fOriginalPDGCharge = -99. ;
    fOriginalPDGEncoding = -99 ; 
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
H02TrackInformation::H02TrackInformation(const G4Track* aTrack)
  : G4VUserTrackInformation()
{
    ...
    // fProcessID = aTrack->GetCreatorProcess()->GetProcessType();
    fOriginalParticleName = aTrack->GetDefinition()->GetParticleName();
    fOriginalPDGCharge = aTrack->GetDefinition()->GetPDGCharge() ;
    fOriginalPDGEncoding = aTrack->GetDefinition()->GetPDGEncoding() ;
}
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
H02TrackInformation& H02TrackInformation
::operator =(const H02TrackInformation& aTrackInfo)
{
    fOriginalTrackID = aTrackInfo.fOriginalTrackID;
    fParticleDefinition = aTrackInfo.fParticleDefinition;
    fOriginalPosition = aTrackInfo.fOriginalPosition;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void H02TrackInformation::SetSourceTrackInformation(const G4Track* aTrack)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void H02TrackInformation::Print() const
{
    G4cout 
