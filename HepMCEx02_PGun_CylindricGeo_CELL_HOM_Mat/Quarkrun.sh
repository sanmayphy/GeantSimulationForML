...
echo $WorkDir/build/HepMCEx02 $WorkDir/HepMCEx02_PGun_CylindricGeo_CELL_HOM_Mat/QuarkMacro.in ${run_number}
$WorkDir/build/HepMCEx02 $WorkDir/HepMCEx02_PGun_CylindricGeo_CELL_HOM_Mat/QuarkMacro.in ${run_number}
